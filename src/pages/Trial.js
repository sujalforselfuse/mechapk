...
const Testimonal = () => {
    return (
        <div id='testimonal' className="flex flex-col items-center justify-center lg:my-40 sm:my-32 my-12 relative z-[500]">

            

            <div className='w-[100%] h-[50%] bg-white blur-[9rem] opacity-10 absolute'></div>
                        ...
                        <div class="lg:h-[28rem] xl:h-[24.5rem] 2xl:h-[32.5rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#FF0000] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                            ...
                            <div className="flex justify-center items-center gap-x-8">
                                ...
                                <div>
                                    ...
                                    <img src='logo (2).svg' alt='' className='2xl:w-[50px] 2xl:h-[60px] lg:h-[24px] w-[35px] xl:h-[44px]' />

                                </div>

                                <div className="flex flex-col items-start">
                                    <p className='text-[#FFFFFF] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Nitesh Deshmukh</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Brainlytics pvt ltd.</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Raipur, Chattisgarh</p>
                                </div>
                            </div>

                            <p class="leading-[27px] text-sm xl:text-base 2xl:text-[1.75rem] 2xl:leading-[2.5rem] mb-3 text-[#989898] text-start">Zorway exceeded expectations! Their user-friendly app, crafted by a skilled development team, and the amazing user experience designed by UI/UX experts impressed us. We wholeheartedly recommend Zorway for their diverse digital services and as a reputable, knowledgeable digital solutions provider.</p>
                        ...
                        <div class="lg:h-[28rem] xl:h-[24.5rem] 2xl:h-[32.5rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#21DAFF] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                            ...
                            <div className="flex justify-center items-center gap-x-8">
                                ...
                                <div>
                                    ...
                                    <img src='logo (6).svg' alt='' className='2xl:w-[50px] 2xl:h-[60px] lg:h-[24px] w-[35px] xl:h-[30px]' />

                                </div>

                                <div className="flex flex-col items-start">
                                    <p className='text-[#FFFFFF] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Shubam prajapati</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Innovative Scripts</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>New Delhi</p>
                                </div>
                            </div>

                            <p class="leading-[27px] text-sm xl:text-base 2xl:text-[1.75rem] 2xl:leading-[2.5rem] mb-3 text-[#989898] text-start">Working with Zorway for our client&apos;s website was a game-changer .Zorway&apos;s proficiency in web development and commitment to comprehending the objectives of our client were exceptional. Our client was delighted with the outcome of the website they produced, which exceeded expectations.</p>
                        ...
                        <div class="lg:h-[28rem] xl:h-[24.5rem] 2xl:h-[32.5rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#0ACF83] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                            ...
                            <div className="flex justify-center items-center gap-x-8">
                                ...
                                <div>
                                    ...
                                    <img src='logo (4).svg' alt='' className='2xl:w-[50px] 2xl:h-[60px] lg:h-[35px] w-[35px] xl:h-[50px]' />

                                </div>

                                <div className="flex flex-col items-start">
                                    <p className='text-[#FFFFFF] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Swamy</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Hanuman Travels</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Hyderabad, Telangana.</p>
                                </div>
                            </div>

                            <p class="leading-[27px]  text-sm xl:text-base 2xl:text-[1.75rem] 2xl:leading-[2.5rem] mb-3 text-[#989898] text-start">Zorway&apos;s quick launch of our website with seamless integration of Google Ads was simply outstanding! Their team&apos;s efficiency and expertise ensured a rapid setup that perfectly complemented our digital marketing strategy. We were thrilled with the results and highly recommend Zorway for their exceptional service and skillful integration of advertising solutions.</p>
                        ...
                        <div class="lg:h-[28rem] xl:h-[24.5rem] 2xl:h-[32.5rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#FF0000] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                            ...
                            <div className="flex justify-center items-center gap-x-8">
                                ...
                                <div>
                                    ...
                                    <img src='logo (8).svg' alt='' className='2xl:w-[50px] 2xl:h-[60px] w-[35px] h-[44px]' />

                                </div>

                                <div className="flex flex-col items-start">
                                    <p className='text-[#FFFFFF] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Dr. Dheeraj Agarwal</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>NIT- Bhopal</p>
                                    <p className='text-[#9A9A9A] 2xl:text-[1.75rem] 2xl:leading-[2.5rem] text-sm'>Bhopal, M.P.</p>
                                </div>
                            </div>

                            <p class="leading-[27px] text-sm 2xl:text-[1.75rem] 2xl:leading-[2.5rem] xl:text-base mb-3 text-[#989898] text-start">Zorway understood our exact requirements and provided a great web platform for us. The outcomes of the service precisely cater to the needs of our institution and contribute to its greater development. Working with Zorway was seamless, and I&apos;m quite pleased with how well they did their Work.</p>
                            ...
                            <div class="sm:h-[25rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#FF0000] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                                ...
                                <div className="flex justify-center items-center gap-x-8">
                                    ...
                                    <div>
                                        ...
                                        <img src='logo (2).svg' alt='' className='w-[35px] h-[30px]' />
                            ...
                            <div class="sm:h-[25rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#FF0000] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                                ...
                                <div className="flex justify-center items-center gap-x-8">
                                    ...
                                    <div>
                                        ...
                                        <img src='logo (6).svg' alt='' className='w-[35px] h-[30px]' />
                            ...
                            <div class="sm:h-[25rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#0ACF83] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                                ...
                                <div className="flex justify-center items-center gap-x-8">
                                    ...
                                    <div>
                                        ...
                                        <img src='logo (4).svg' alt='' className='w-[35px] h-[30px]' />
                            ...
                            <div class="sm:h-[25rem] bg-transparent bg-opacity-75 px-4 pt-12 pb-6 border-2 border-[#0ACF83] rounded-[16px] overflow-hidden relative flex flex-col gap-y-8">
                                ...
                                <div className="flex justify-center items-center gap-x-8">
                                    ...
                                    <div>
                                        ...
                                        <img src='logo (8).svg' alt='' className='w-[35px] h-[30px]' />
